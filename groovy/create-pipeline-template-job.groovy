...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/bachkouty-cloudbees-com/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>bachkouty-cloudbees-com</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>bachkouty-cloudbees-com</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/bachkouty-cloudbees-com/pipeline-template-catalog.git</repositoryUrl>
              <traits>
